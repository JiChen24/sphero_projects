...
if __name__=="__main__":
    ...
    color_pub = rospy.Publisher(sphero_name + '/set_color', ColorRGBA, queue_size=1, latch=True)
    ...
    a1 = vt.ViconTrackerPoseHandler(None, None, "",51024, 'Sphero8')

    a2 = vt.ViconTrackerPoseHandler(None, None, "",51017, 'Sphero1')
    a3 = vt.ViconTrackerPoseHandler(None, None, "",51018, 'Sphero2')
    a4 = vt.ViconTrackerPoseHandler(None, None, "",51019, 'Sphero3')
    ...
    b4 = vt.ViconTrackerPoseHandler(None, None, "",51020, 'Sphero4')
